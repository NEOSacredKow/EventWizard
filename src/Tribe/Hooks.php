...
class Hooks extends \tad_DI52_ServiceProvider {
	...
	protected function add_actions() {
		...
		add_action( 'tribe_ext_events_wizard_event_add', [ $this, 'action_save_selected_venues' ], 10, 2 ); // Add this line
	...
	// Venue selection and save
	public function action_save_selected_venues( $event_id, $_post ) {
        	$this->container->make( Wizard::class )->save_selected_venues( $event_id, $_post );
	}
}
